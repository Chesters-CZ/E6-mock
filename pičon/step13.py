...
load_csv("step11\\favorites.csv", discard, favorites, False)

favorites_final = [fav for fav in favorites if fav[1] in post_ids]

comments = []

load_csv("step12\\comment_text_post.csv", discard, comments, False)

comments_final = [comment for comment in comments if comment[3] in post_ids]

dump_database(favorites_final, [], "step13\\favorites.csv")

dump_database(comments_final, [], "step13\\comments.csv")
